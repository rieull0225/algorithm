...
public class Main_SWEA_4013_특이한자석_박민준 {
    ...
    static void rotate(int num, int dir){
        ...
        if(num > 0 && wheel[num][6 + dir] != wheel[num-1][2]) rotate(num-1, dir*-1);
        if(num < 3 && wheel[num][2 + dir] != wheel[num+1][6]) rotate(num+1, dir*-1);
